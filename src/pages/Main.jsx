    ...
    <div className='gap-10'>
      <div className='px-8'>
        <div className='flex flex-col px-0 md:flex-row justify-center items-center md:px-10'>
          <div className='flex flex-col  items-center w-full md:w-full md:pb-10  lg:pb-36'>
          ...
          <div className='flex justify-center items-center mt-8 w-full lg:w-auto md:flex-row flex-col md:flex gap-0 lg:gap-5 md:gap-5'>
            <div className='flex flex-col w-full md:w-1/2 justify-center items-center'>
              <div className='flex flex-col justify-center items-center gap-5 '>
                <div className='flex flex-col justify-center gap-9 items-center md:flex-row lg:flex-row'>
                  <div className='bg-white w-full h-[15rem] text-center text-2xl hover:transform hover:scale-105 transition duration-300 ease-in-out font-semibold pr-[4rem] pl-[4rem] pt-6 pb-6 mb-3'>
                    <h1>More than</h1>
                    <br />
                    <h1 className='text-3xl text-blue-400'>1000</h1>
                    <br />
                    <h1> Writers</h1>
                  </div>
                  <div className='bg-white w-full h-[15rem] text-center text-2xl hover:transform hover:scale-105 transition duration-300 ease-in-out font-semibold pr-[4rem] pl-[4rem] pt-6 pb-6 mb-3'>
                ...
                <div className='bg-white w-[20rem] h-auto text-center text-2xl hover:transform hover:scale-105 transition duration-300 ease-in-out font-semibold pr-[4rem] pl-[4rem] pt-6 pb-6 mb-3'>
                  <h1>More than</h1>
                  <br />
                  <h1 className='text-3xl text-blue-400'>1000</h1>
                  <br />
      ...
      <div className='flex justify-center items-center px-3 py-3'>
        <div className=" w-full md:ml-10 flex flex-col md:w-1/2 px-10 py-10 shadow-2xl backdrop-blur-3xl rounded-3xl h-fit">
          <div className="flex flex-col opacity-1 transform-none text-justify md:block md:py-0">
            ...
            <button className="w-32 py-1 px-1 mt-5 text-lg text-white rounded-full bg-[#2956A8] font-Regular md:text-xl md:py-3 md:w-64">
              <Link to="/sample">
                Learn More
              </Link>
            </button>
      ...
      <div className="flex flex-col items-center px-4 py-4  m-4  justify-center text-xl font-semibold md:text-5xl">
        ...
        <button className="w-32 py-1  text-lg text-white rounded-full bg-[#2956A8] md:font-SemiBold md:text-2xl md:py-3 md:w-48"><Link to="/login">
          Join Them
        </Link>
        </button>
      </div>
